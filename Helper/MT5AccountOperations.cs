...
namespace MT5ConnectionService.Helper
{
    ...
    {
        public static MtGetAllLiveAccountVM GetSingleAccount(CIMTManagerAPI manager, ulong loginId)
        {
        ...
        public static IEnumerable<MtGetAllLiveAccountVM> GetAllAccounts(CIMTManagerAPI manager)
        {
            List<MtGetAllLiveAccountVM> accounts = new List<MtGetAllLiveAccountVM>();
        ...
        public static List<MtGetAllLiveAccountVM> GetAccountsByLoginIds(CIMTManagerAPI manager, List<ulong> loginIds)
        {
        ...
        public static BaseResponseModel<int> SetAccountActiveStatus(CIMTManagerAPI manager, MT5AccountInActiveVM entity)
        {
        ...
        public static MTRetCode DepositOrWithdrawBalance(CIMTManagerAPI manager, MTFiveDepositBalanceVM entity)
        {
            MTRetCode mTRetCode;
            ulong variable = 0;
