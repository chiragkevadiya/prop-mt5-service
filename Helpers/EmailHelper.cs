...
namespace PropMT5ConnectionService.Helpers
{
    ...
    public class EmailHelper
    {
        ...
        private string GetMimeType(string filePath)
        {
            ...
            // Use the traditional C# switch statement
            switch (extension)
            {
                case ".pdf":
                    return "application/pdf";

                // Grouping similar cases to return the same MIME type
                case ".jpg":
                case ".jpeg":
                    return "image/jpeg";
                ...
                case null:
                case "":
                    // Handle paths without an extension explicitly
                    return "application/octet-stream";

                default:
                    // The default case replaces the "_" in the switch expression
                    return "application/octet-stream";
            }
        }
